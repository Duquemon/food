...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3382847619721076194L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAvroModel\",\"namespace\":\"com.food.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"scoring\",\"type\":\"int\"}]}");
   ...
   * @param scoring The new value for scoring
   */
  public CustomerAvroModel(java.lang.String id, java.lang.String username, java.lang.String firstName, java.lang.String lastName, java.lang.Integer scoring) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: scoring = (java.lang.Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return The value of the 'scoring' field.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[4], other.scoring)) {
        this.scoring = data().deepCopy(fields()[4].schema(), other.scoring);
    ...
    /**
      * Sets the value of the 'scoring' field.
      * @param value The value of 'scoring'.
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder setScoring(int value) {
    ...
    /**
      ...
      * @return True if the 'scoring' field has been set, false otherwise.
      */
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder clearScoring() {
    ...
    public CustomerAvroModel build() {
      try {
        ...
        record.scoring = fieldSetFlags()[4] ? this.scoring : (java.lang.Integer) defaultValue(fields()[4]);
        return record;
