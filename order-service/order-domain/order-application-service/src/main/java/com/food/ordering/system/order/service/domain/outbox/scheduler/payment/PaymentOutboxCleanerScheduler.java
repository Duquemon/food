...
public class PaymentOutboxCleanerScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        Optional<List<OrderPaymentOutboxMessage>> outboxStatusAndSagaStatus = paymentOutboxHelper
        ...
        if (outboxStatusAndSagaStatus.isPresent()) {
            List<OrderPaymentOutboxMessage> orderPaymentOutboxMessages = outboxStatusAndSagaStatus.get();
